        ...
        if (score != null) {
            if (columnValue.length() > 0) {
                ...
                if (columnType.equals(Constants.DECIMAL_RESULT_TYPE)) {
                    ...
                    columnValue = columnValue.toLowerCase(Locale.ENGLISH);
...
// the column if it does not exist
    public static Lineitem getColumn(B2Context b2Context, String toolId, String toolName, String scaleType, Integer points,
        ...
        Id courseId = b2Context.getCourseId();
        Id contentId = b2Context.getContentId();
        ...
        if (ok) {
            ...
            if (b2Context.hasContentContext()) {
// Delete any existing line item setting values
                if (lineitemId0Str.length() > 0) {
                    ...
                    b2Context.setSetting(false, true, toolSettingPrefix + Constants.TOOL_LINEITEM, lineitemId0Str);
                    b2Context.persistSettings(false, true);
                }
                Id lineitemId = Utils.getLineItemIdByContentId(b2Context.getContentId());
            ...
            if ((lineitem == null) && doCreate) {
                try {
                    ...
                    try {
                        ...
                        B2Context.log(false, e.getMessage(), e);
                    }
